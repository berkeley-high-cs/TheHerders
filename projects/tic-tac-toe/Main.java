...
class Main {
    ...
    //function that does basically this, need p1Input to be global, then function that does whats happening below, then check to see if anyone has won
     String test = ("");
         //these three lines should run a majority of our game, just need to make a check system and a way for there to be two players
    ...
    public static void printBoard (int[][] board) {
        for(int i = 0; i < 3; i++) {
            System.out.println(asLetter(board[i][0]) + "  |  " + asLetter(board[i][1]) + "  |  " + asLetter(board[i][2]));
					System.out.println(""); 
					//Pretty cool, loops three times, while also changing the first value of the array id, which works because its a three by three board, but if it were 4 by 3 or something like that it might be more complicated
        }
    }
    //as letter changes the numbers to x's and o's, ask grayson a little bit about how that works, like why is it just in front of the array id
    //for loop
    ...
    public static void p1Reader (String p1Input){
        ...
        public static void p1Chat(String test){
            System.out.println("");
    System.out.println("What is player 1's move? 1 through 9, left to right, up to down. Don't chose something thats been done");
    Scanner scanner = new Scanner(System.in);
    p1Input = scanner.nextLine();
        }
        public static void p2Chat(String test){
            System.out.println("");
    System.out.println("What is player 2's move? 1 through 9, left to right, up to down. Don't chose something thats been done");
    Scanner scanner = new Scanner(System.in);
      ...
      public static void p2Reader (String p2Input){
        ...
        //check for win con
          public static void checker(int x){
            ...
            } //tie checks if there are any spaces left, currently check if any space has been taken
